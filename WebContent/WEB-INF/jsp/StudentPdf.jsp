...
<body bgcolor="orange">
<%@
page import="java.io.*,com.goschool.beans.Student, java.awt.Color, com.itextpdf.text.*, com.itextpdf.text.pdf.*,javax.mail.util.ByteArrayDataSource,javax.mail.*,java.util.Properties,javax.activation.DataHandler,javax.mail.internet.*,java.net.URL"
%>
<% Student studentpdf=(Student)request.getAttribute("studentpdf");%>

<%
System.out.println("user name:"+studentpdf.getFirstName());
...
//testing2
 PdfPTable Table = new PdfPTable(2);
      ...
      PdfPCell cell2 = new PdfPCell(new Paragraph(studentpdf.getFirstName(),FontFactory.getFont(FontFactory.HELVETICA, 24f, Font.BOLD, BaseColor.RED)));
      ...
      PdfPCell cell4 = new PdfPCell(new Paragraph(studentpdf.getLastName(),FontFactory.getFont(FontFactory.HELVETICA, 24f, Font.BOLD, BaseColor.RED)));
      ...
      PdfPCell cell6 = new PdfPCell(new Paragraph(studentpdf.getSchoolName(),FontFactory.getFont(FontFactory.HELVETICA, 24f, Font.BOLD, BaseColor.RED)));
     ...
     // cell1.setPaddingBottom(5f);
      ...
      PdfPCell cell8 = new PdfPCell(new Paragraph(studentpdf.getEmail(),FontFactory.getFont(FontFactory.HELVETICA, 24f, Font.BOLD, BaseColor.RED)));
      ...
      PdfPCell cell10 = new PdfPCell(new Paragraph(studentpdf.getPhone(),FontFactory.getFont(FontFactory.HELVETICA, 24f, Font.BOLD, BaseColor.RED)));
